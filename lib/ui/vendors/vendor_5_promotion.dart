...
class VendorPromoPromoPage extends StatefulWidget {
  ...
  State<StatefulWidget> createState() {
    return VendorPromoPromoPageState();
  }
}

class VendorPromoPromoPageState extends State<VendorPromoPromoPage> {
