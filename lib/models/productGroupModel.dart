...
ProductGroupModel productGroupModelFromJson(String str) => ProductGroupModel.fromJson(json.decode(str));

String productGroupModelToJson(ProductGroupModel data) => json.encode(data.toJson());
